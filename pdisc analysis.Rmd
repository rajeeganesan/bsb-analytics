...
goal: identify a potential correlation between the sabermetric
clutch statistic and whether or not plate discipline can be 
utilized as a predictive model to identify a player's clutch.
...
that i have calculated from the original statistics. 
...
to start, i chose to compare the average disc ratings among all
